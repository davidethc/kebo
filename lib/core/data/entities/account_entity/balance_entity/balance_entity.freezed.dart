...
abstract class $BalanceEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({double current, double available});
}
...
class _$BalanceEntityImpl extends _BalanceEntity {
  const _$BalanceEntityImpl({this.current = 0, this.available = 0}) : super._();
  ...
  @override
  String toString() {
    return 'BalanceEntity(current: $current, available: $available)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, current, available);
...
abstract class _BalanceEntity extends BalanceEntity {
  const factory _BalanceEntity({final double current, final double available}) =
      _$BalanceEntityImpl;
