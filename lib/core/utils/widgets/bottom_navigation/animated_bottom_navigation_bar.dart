...
import 'package:kebo_app/core/data/enums/bottom_bar_enum.dart';
    ...
    for (var i = 0; i < itemCount; i++) {
      ...
      items.add(
        NavigationBarItem(
          ...
          label: widget.icons?.elementAt(i).asString() ?? '',
          icon: widget.icons?.elementAt(i).icon() ?? Icons.add,
