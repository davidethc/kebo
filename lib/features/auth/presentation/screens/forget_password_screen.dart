...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen>
  ...
  void _blocListener(BuildContext context, ForgetPasswordState state) {
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<ForgetPasswordCubit, ForgetPasswordState>(
                builder: (context, ForgetPasswordState state) => Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      LinearPercentIndicator(
                        ...
                        backgroundColor: const Color.fromARGB(255, 38, 96, 255),
              ...
              BlocBuilder<ForgetPasswordCubit, ForgetPasswordState>(
                builder: (context, ForgetPasswordState state) => Expanded(
                  child: IndexedStack(
  ...
  Widget _buildPassword() {
    return BlocBuilder<ForgetPasswordCubit, ForgetPasswordState>(
      builder: (context, ForgetPasswordState state) => Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 189, 36, 36),
              borderRadius: BorderRadius.circular(12),
              boxShadow: [
                BoxShadow(
                    color: const Color.fromARGB(255, 42, 202, 20),
                    spreadRadius: 5,
                    blurRadius: 7,
      ...
      builder: (context, ForgetPasswordState state) => Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border:
                    Border.all(color: const Color.fromARGB(255, 218, 42, 74)),
            ...
            child: Row(
              children: [
                  ...
                  SizedBox(
                    ...
                    child: InternationalPhoneNumberInput(
                      ...
                      onInputChanged: (PhoneNumber number) =>
                          cubit.onChangeCountryCode(number),
                ...
                Expanded(
                  child: AppInput(
                    ted: cubit.usernameController,
                    inputDecoration: InputDecoration(
                      hintText: S.current.phoneOrEmail,
                    ...
                    err: state.errorUsername?.asString(context),
                  ),
                ),
              ],
            ),
          ...
          if (state.errorUsername != null) ...[
            ...
            Align(
              ...
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(
                  S.current.inputErrorRequiredEmpty,
        ...
        children: [
          ...
          Text(
            S.current.weWillTextYouNumber(
                '\n${state.isPhone ? state.getPhoneNumber : state.username}'),
            textAlign: TextAlign.center,
            style: context.theme.textTheme.bodyLarge?.copyWith(fontSize: 16),
          ),
          if (!context.hasKeyboardPopUp)
